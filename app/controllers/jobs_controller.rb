class JobsController < ApplicationController
  ...
  private
    ...
    def job_params
      params.require(:job).permit(:description, :job_title, :education_level, :years_experience, :business_field1, :business_field2, :region, :hourly_rate, :city, :project_length, :image)
    end
end
